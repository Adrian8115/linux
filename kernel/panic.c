...
void panic(const char *fmt, ...)
{
	...
	pr_emerg("Bruh Moment [Joseph Vissarionovich Stalin is unhappy] - not syncing: %s\n", buf);

	/*
	* Praise him that you were allowed to get a Bruh Moment!
	* Panic is command of superior leader.
	* 
	* ⡿⠄⢀⣼⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⠞⠛⠁⠄⡼⣿⣿
	* ⣿⡇⠄⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠙⣦⠐⠠⡥⣿⣿
	* ⣿⡇⠄⣿⡿⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣾⣿⡔⠛⣿⣿
